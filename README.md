...
当前阶段为 **model-core MVP sandbox + first foundation inference smoke**。
...
下一步建议：拿一份真实 FU13 导出数据填充 schema map，先完成真实数据 validation，再把已跑通的 TTM 链路迁移到真实数据上，并继续做 TimesFM、Chronos、Moirai 等开源模型的 frozen inference 对比。
